...
namespace docraft::loom::craft {
    /**
     * @brief Handles `<Header>`/`<Body>`/`<Footer>`, all three sharing the same
     * `ParsedSectionData` shape and all built as a `DocraftLoomVStack`.
     */
    class DOCRAFT_LIB DocraftLoomSectionHandler : public IDocraftLoomTagHandler
    {
    public:
