...
namespace docraft::loom::craft {
    /**
     * @brief Handles both `<List>` and `<UList>` (both map to the same
     * `DocraftLoomList`, distinguished by `kind`).
     */
    class DOCRAFT_LIB DocraftLoomListHandler : public IDocraftLoomTagHandler
    {
    public:
