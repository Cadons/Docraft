...
namespace docraft::craft::parser {
    std::any DocraftRectangleParser::parse(const pugi::xml_node& craft_language_source)
    {
        ...
        if (auto border_style_attr = craft_language_source.attribute(
                elements::rectangle::attribute::kBorderStyle.data())) {
    ...
    std::vector<std::string_view> DocraftRectangleParser::accepted_attributes() const
    {
        return {
            ...
            elements::rectangle::attribute::kBorderStyle
        };
    }
} // namespace docraft::craft::parser
